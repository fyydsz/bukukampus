...
export default function Home() {
  return (
    <div className="flex items-center justify-center min-h-screen md:min-h-0 md:items-start md:justify-start md:pt-32 overflow-hidden px-4 sm:px-6 py-8">
      <main className="flex flex-col items-center space-y-4 text-center xl:items-start xl:text-left max-w-2xl sm:max-w-3xl md:max-w-6xl w-full -translate-y-[8vh] md:translate-y-0 transition-transform">
        {/* Badge */}
